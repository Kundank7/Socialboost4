...
import { Instagram, Facebook, Youtube, TextIcon as Telegram, Calculator, Link2 } from "lucide-react"
...
import { getServicesByPlatform, getAllPlatforms } from "@/lib/actions"
...
export default function SelectService() {
  ...
  useEffect(() => {
    setTotal((quantity / 1000) * servicePrice)
        ...
        <Card className="glass-card">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-muted-foreground">
                Minimum order: 1,000 | Price: ${servicePrice.toFixed(2)} per 1,000
              </p>
            </div>
          ...
          <CardFooter>
            <Button
              ...
              className="w-full"
              size="lg"
              disabled={!selectedPlatform || !selectedService || !socialLink || quantity < 1000}
            >
              Buy Now
            </Button>
          </CardFooter>
